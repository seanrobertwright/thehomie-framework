...
| YourBusiness Native Agent Agency | Private tenant planning/operator baseline — not public-exported; no live action authorization | [YourBusiness-native-agent-agency](features/YourBusiness-native-agent-agency.md) | YourBusiness/Supabase truth, Homie personas, Agent Command drafts/receipts, Dograh current voice adapter, future gated LiveKit adapter, sanitized game events |
