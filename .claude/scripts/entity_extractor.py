...
# Contradiction detection lives in its own module (WS2, issue #83). These
# symbols are re-exported here so every existing consumer keeps importing them
# from entity_extractor unchanged. The dependency arrow is one-way:
# entity_extractor -> entity_contradictions (never the reverse).
from entity_contradictions import (  # noqa: E402
    Contradiction,
...
# ---------------------------------------------------------------------------
# Contradiction detection — moved to entity_contradictions.py (WS2, issue #83).
# Contradiction, check_contradictions, and insert_contradiction_callouts are
# re-exported via the import near the top of this file.
# ---------------------------------------------------------------------------
